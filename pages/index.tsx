        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We make it easy to discover, book, and enjoy amazing events across
              India
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 rounded-lg hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Join thousands of event-goers and discover events from verified
                organizers
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            {[
              ...
              <Link key={category.name} href={category.link}>
                <div className="text-center p-6 rounded-lg border hover:shadow-lg transition-all cursor-pointer group">
                  <div
